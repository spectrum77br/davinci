...
<template>
  <div class="space-y-5">
        ...
        <table class="min-w-[2000px] text-xs border-collapse">
          <thead class="sticky top-0 z-20 bg-background">
            ...
            <tr class="border-b">
              ...
              <th class="px-2 py-1 text-left font-semibold text-[11px] text-muted-foreground whitespace-nowrap min-w-[120px] bg-red-50 dark:bg-red-900/20" title="Até quando a plataforma espera uma resposta da loja neste caso (TikTok: confirmar/recusar o pacote recebido, responder ao reembolso; Shopee: conferir o pacote recebido em 3 dias, enviar evidências, responder à proposta). Passado o prazo ela decide sozinha. Vermelho = menos de 24 h ou vencido. Passe o mouse na célula pra ver o que fazer. Mercado Livre não informa prazo pela API.">Prazo p/ responder</th>
    ...
    <InformarThreemaModal
      ...
      enviar-com-auto
      descricao="Quem está marcado recebe no Threema o aviso automático de prazo: quando falta menos de 24 h pra loja responder na plataforma (TikTok: confirmar ou recusar o pacote recebido; Shopee: conferir o pacote recebido, enviar evidências, responder à proposta), e um último aviso faltando 4 h — por caso e por prazo. O pedido de só reembolso tem aviso próprio pela aba Chamados. 'Enviar agora' manda a lista dos pedidos aguardando devolução (a mesma da aba Acompanhamento), com dias parados, última localização e prazo. A seleção fica salva."
